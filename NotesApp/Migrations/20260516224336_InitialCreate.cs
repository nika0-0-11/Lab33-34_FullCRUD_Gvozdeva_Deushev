        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "Написать отчет по лабораторной работе №30 до конца недели.", new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc), false, false, 4, "Подготовить отчет", new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3, 3, "Сделать приложение для отслеживания расхода.", new DateTime(2026, 1, 3, 0, 0, 0, 0, DateTimeKind.Utc), false, false, 3, "Идеи для проекта", new DateTime(2026, 1, 3, 0, 0, 0, 0, DateTimeKind.Utc) },
